...
a94453aaa_6364_0361_e42e_1cf639a78f1b = spark.read.load('D:\Spark\spark-2.2.0-bin-hadoop2.7\spark-2.2.0-bin-hadoop2.7\data\mllib\sample_linear_regression_data.txt')
af1ed1f3b_8bb2_2382_d707_91362e48f4df = spark.read.load('D:\Spark\spark-2.2.0-bin-hadoop2.7\spark-2.2.0-bin-hadoop2.7\data\mllib\sample_linear_regression_data.txt')
